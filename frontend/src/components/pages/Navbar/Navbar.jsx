...
<header>
            ...
            <div className="logo">
            <NavLink to="/"><img className = "logo1" src={logo} /></NavLink>
            ...
            <nav>
              ...
              <div className="buttons" style={{backgroundColor: 'white'}}>
                            {/* <NavLink to="/register" className="btn btn-outline-dark ms-2"><i className="fa fa-user-plus me-1"></i> Register</NavLink> */}
                            <NavLink to="/cart" className="btn btn-outline-dark ms-2"><i className="fa fa-shopping-cart me-1"></i>{totalUniqueItems}</NavLink>
                        </div>
                        {user? (
                            ...
                            <>
                                 <NavLink to="/login" className="btn btn-outline-dark ms-2" style={{backgroundColor: 'white'}}><i className="fa fa-sign-in me-1"></i> Login</NavLink>
                            </>
                        )}
            </nav>
